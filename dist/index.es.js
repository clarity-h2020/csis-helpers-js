...
var dist_4 = createCommonjsModule(function (module, exports) {

Object.defineProperty(exports, '__esModule', { value: true });

function _interopDefault (ex) { return (ex && (typeof ex === 'object') && 'default' in ex) ? ex['default'] : ex; }

var log$1 = _interopDefault(log);
    ...
    return regenerator.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 12:
            log$1.error('no field field_basic_auth_credentials in user profile ' + userResponse.data.data.attributes.name);
            return _context2.abrupt("return", null);
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            requestUrl = csisBaseUrl + '/jsonapi/group/study/' + studyUuid + '?include=' + include;
            _context3.prev = 4;
            log$1.debug('fetching study from CSIS API: ' + requestUrl);
            _context3.next = 8;
            return csisClient.get(requestUrl, {
              withCredentials: true
            });
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            requestUrl = csisBaseUrl + '/jsonapi/node/data_package/' + datapackageUuid + '?include=' + include;
            _context4.prev = 4;
            log$1.debug('fetching datapackage from CSIS API:' + requestUrl);
            _context4.next = 8;
            return csisClient.get(requestUrl, {
              withCredentials: true
            });
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            requestUrl = csisBaseUrl + '/jsonapi/node/data_package/' + datapackageUuid + '/field_resources?include=' + include;
            _context5.prev = 4;
            log$1.debug('fetching datapackage resources from CSIS API:' + requestUrl);
            _context5.next = 8;
            return csisClient.get(requestUrl, {
              withCredentials: true
            });
  ...
  createClass(CSISHelpers, null, [{
    ...
    value: function extractEmikatIdFromStudyGroupNode(studyGroupNode) {
      ...
      if (studyGroupNode.attributes.field_emikat_id !== undefined && studyGroupNode.attributes.field_emikat_id != null && !isNaN(studyGroupNode.attributes.field_emikat_id)) {
        ...
        log$1.warn('no emikat id in study ' + studyGroupNode.attributes.field_emikat_id);
      }
    ...
    value: function extractStudyAreaFromStudyGroupNode(studyGroupNode) {
      ...
      if (studyGroupNode && studyGroupNode.attributes && studyGroupNode.attributes.field_area != null && studyGroupNode.attributes.field_area.value != null) {
        ...
        log$1.warn('no study area in study ' + studyGroupNode);
      }
    ...
    value: function filterResourcesbyTagName(resourceArray, tagsArray, tagType, tagName) {
      ...
      var filteredResourceArray = resourceArray.filter(function (resource) {
        if (resource.relationships.field_resource_tags != null && resource.relationships.field_resource_tags.data != null && resource.relationships.field_resource_tags.data.length > 0) {
          ...
          log$1.warn('no tags found  in resource ' + resource.id);
        }

        return false;
      });
      log$1.debug(filteredResourceArray.length + ' resources left after filtering ' + resourceArray.length + ' resources by tag type ' + tagType + ' and tag name ' + name);
      return filteredResourceArray;
    }
    /**
    * Filters resource array by tag id which are included in the tags array (due to Drupal API quirks).
    ...
    */
    ...
    value: function filterResourcesByEuglId(resourceArray, tagsArray, id) {
      ...
      var filteredResourceArray = resourceArray.filter(function (resource) {
        if (resource.relationships.field_resource_tags != null && resource.relationships.field_resource_tags.data != null && resource.relationships.field_resource_tags.data.length > 0) {
          ...
          log$1.warn('no EU-GL tags found  in resource ' + resource.id);
        }

        return false;
      });
      log$1.debug(filteredResourceArray.length + ' resources left after filtering ' + resourceArray.length + ' resources by tag type ' + tagType + ' and EU-GL id ' + id);
      return filteredResourceArray;
    }
    /**
       * Filters resource array by reference type which are included in the references array (due to Drupal API quirks).
    ...
    value: function filterResourcesbyReferenceType(resourceArray, referencesArray, referenceType) {
      var filteredResourceArray = resourceArray.filter(function (resource) {
        if (resource.relationships.field_references != null && resource.relationships.field_references.data != null && resource.relationships.field_references.data.length > 0) {
          ...
          log$1.warn("no references found in resource '".concat(resource.attributes.title, "' (").concat(resource.id, ")"));
        }

        return false;
      }); // ES6 template string: https://eslint.org/docs/rules/no-template-curly-in-string

      log$1.debug("".concat(filteredResourceArray.length, " resources left after filtering ").concat(resourceArray.length, " resources by reference type ").concat(referenceType));
      return filteredResourceArray;
    }
    /**
        * Extracts references which are included in the references array (due to Drupal API quirks) from a resource
    ...
    value: function extractReferencesfromResource(resource, referencesArray, referenceType) {
      ...
      log$1.debug("".concat(references.length, " references found in resouce for reference type ").concat(referenceType));
      return references;
    }
    /**
        * Extracts tags which are included in the tags array (due to Drupal API quirks) from a resource
    ...
    value: function extractTagsfromResource(resource, tagsArray, tagType) {
      ...
      log$1.debug("".concat(tags.length, " tags found in resouce for tag type ").concat(tagType));
      return tags;
    }
  }]);
...
var log$1$1 = _interopDefault(log$1);
var axios$1$1 = _interopDefault(axios$1);
...
var csisClient = axios$1$1.create({
  withCredentials: true
});
csisClient.defaults.headers.common['Accept'] = 'application/vnd.api+json';
csisClient.defaults.headers.common['Content-Type'] = 'application/vnd.api+json';
    ...
    return regenerator.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 12:
            log$1$1.error('no field field_basic_auth_credentials in user profile ' + userResponse.data.data.attributes.name);
            return _context2.abrupt("return", null);
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            requestUrl = csisBaseUrl + '/jsonapi/group/study/' + studyUuid + '?include=' + include;
            _context3.prev = 4;
            log$1$1.debug('fetching study from CSIS API: ' + requestUrl);
            _context3.next = 8;
            return csisClient.get(requestUrl, {
              withCredentials: true
            });
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            requestUrl = csisBaseUrl + '/jsonapi/node/data_package/' + datapackageUuid + '?include=' + include;
            _context4.prev = 4;
            log$1$1.debug('fetching datapackage from CSIS API:' + requestUrl);
            _context4.next = 8;
            return csisClient.get(requestUrl, {
              withCredentials: true
            });
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            requestUrl = csisBaseUrl + '/jsonapi/node/data_package/' + datapackageUuid + '/field_resources?include=' + include;
            _context5.prev = 4;
            log$1$1.debug('fetching datapackage resources from CSIS API:' + requestUrl);
            _context5.next = 8;
            return csisClient.get(requestUrl, {
              withCredentials: true
            });
...
var EMIKAT_STUDY_ID = '$emikat_id';
var emikatClient = axios$1$1.create();
/**
 * 
 * @param {String} url
 * @param {String} emikatCredentials
  ...
  createClass(CSISHelpers, null, [{
    ...
    value: function extractEmikatIdFromStudyGroupNode(studyGroupNode) {
      ...
      if (studyGroupNode.attributes.field_emikat_id !== undefined && studyGroupNode.attributes.field_emikat_id != null && !isNaN(studyGroupNode.attributes.field_emikat_id)) {
        ...
        log$1$1.warn('no emikat id in study ' + studyGroupNode.attributes.field_emikat_id);
      }
    ...
    value: function extractStudyAreaFromStudyGroupNode(studyGroupNode) {
      ...
      if (studyGroupNode && studyGroupNode.attributes && studyGroupNode.attributes.field_area != null && studyGroupNode.attributes.field_area.value != null) {
        ...
        log$1$1.warn('no study area in study ' + studyGroupNode);
      }
    ...
    value: function filterResourcesbyTagName(resourceArray, tagsArray, tagType, tagName) {
      ...
      var filteredResourceArray = resourceArray.filter(function (resource) {
        if (resource.relationships.field_resource_tags != null && resource.relationships.field_resource_tags.data != null && resource.relationships.field_resource_tags.data.length > 0) {
          ...
          log$1$1.warn('no tags found  in resource ' + resource.id);
        }

        return false;
      });
      log$1$1.debug(filteredResourceArray.length + ' resources left after filtering ' + resourceArray.length + ' resources by tag type ' + tagType + ' and tag name ' + name);
      return filteredResourceArray;
    }
    /**
    * Filters resource array by tag id which are included in the tags array (due to Drupal API quirks).
    ...
    */
    ...
    value: function filterResourcesByEuglId(resourceArray, tagsArray, id) {
      ...
      var filteredResourceArray = resourceArray.filter(function (resource) {
        if (resource.relationships.field_resource_tags != null && resource.relationships.field_resource_tags.data != null && resource.relationships.field_resource_tags.data.length > 0) {
          ...
          log$1$1.warn('no EU-GL tags found  in resource ' + resource.id);
        }

        return false;
      });
      log$1$1.debug(filteredResourceArray.length + ' resources left after filtering ' + resourceArray.length + ' resources by tag type ' + tagType + ' and EU-GL id ' + id);
      return filteredResourceArray;
    }
    /**
       * Filters resource array by reference type which are included in the references array (due to Drupal API quirks).
    ...
    value: function filterResourcesbyReferenceType(resourceArray, referencesArray, referenceType) {
      var filteredResourceArray = resourceArray.filter(function (resource) {
        if (resource.relationships.field_references != null && resource.relationships.field_references.data != null && resource.relationships.field_references.data.length > 0) {
          ...
          log$1$1.warn("no references found in resource '".concat(resource.attributes.title, "' (").concat(resource.id, ")"));
        }

        return false;
      }); // ES6 template string: https://eslint.org/docs/rules/no-template-curly-in-string

      log$1$1.debug("".concat(filteredResourceArray.length, " resources left after filtering ").concat(resourceArray.length, " resources by reference type ").concat(referenceType));
      return filteredResourceArray;
    }
    /**
        * Extracts references which are included in the references array (due to Drupal API quirks) from a resource
    ...
    value: function extractReferencesfromResource(resource, referencesArray, referenceType) {
      ...
      log$1$1.debug("".concat(references.length, " references found in resouce for reference type ").concat(referenceType));
      return references;
    }
    /**
        * Extracts tags which are included in the tags array (due to Drupal API quirks) from a resource
    ...
    value: function extractTagsfromResource(resource, tagsArray, tagType) {
      ...
      log$1$1.debug("".concat(tags.length, " tags found in resouce for tag type ").concat(tagType));
      return tags;
    }
  }]);
...
unwrapExports(dist);
var dist_1 = dist.CSISHelpers;
var dist_2 = dist.CSISRemoteHelpers;
var dist_3 = dist.EMIKATHelpers;
...
var data = {
	type: "group--study",
	id: "c3609e3e-f80f-482b-9e9f-3a26226a6859",
	attributes: {
		drupal_internal__id: 1,
		langcode: "en",
		label: "Adaptation Scenarios for Metropolitan Resilience Planning",
		created: "2018-10-15T14:17:45+00:00",
		changed: "2019-08-02T14:28:11+00:00",
		path: {
			alias: "/study/1",
			pid: 20,
			langcode: "en"
		...
		field_area: {
			value: "POLYGON((14.150047 40.830437,14.150047 40.892753,14.322395 40.892753,14.322395 40.830437,14.150047 40.830437))",
			geo_type: "Polygon",
			lat: 40.861594999937324,
			lon: 14.236220999978476,
			left: 14.150047,
			top: 40.892753,
			right: 14.322395,
			bottom: 40.830437,
			geohash: "sr60",
			latlon: "40.861594999937,14.236220999978"
		},
		field_emikat_id: "2846",
		field_name: null,
		field_progress_indicator: "7",
		field_publish: true,
		field_short_name: "DC1",
		field_study_goa: "This is just a test case for demonstration purposes."
	},
	relationships: {
		group_type: {
			data: {
				type: "group_type--group_type",
				id: "c7228e47-793b-488b-a370-6a25b1fa9596"
			},
			links: {
				self: {
					href: "https://csis.myclimateservice.eu/jsonapi/group/study/c3609e3e-f80f-482b-9e9f-3a26226a6859/relationships/group_type"
				},
				related: {
					href: "https://csis.myclimateservice.eu/jsonapi/group/study/c3609e3e-f80f-482b-9e9f-3a26226a6859/group_type"
				}
			}
		},
		uid: {
			data: {
				type: "user--user",
				id: "77cf7390-cd8b-44d8-913d-d47829ff5cb7"
			},
			links: {
				self: {
					href: "https://csis.myclimateservice.eu/jsonapi/group/study/c3609e3e-f80f-482b-9e9f-3a26226a6859/relationships/uid"
				},
				related: {
					href: "https://csis.myclimateservice.eu/jsonapi/group/study/c3609e3e-f80f-482b-9e9f-3a26226a6859/uid"
				}
			}
		},
		field_city_region: {
			data: {
				type: "taxonomy_term--cities_regions",
				id: "af1c063c-ae58-4f39-9201-6ceb487eca76"
			},
			links: {
				self: {
					href: "https://csis.myclimateservice.eu/jsonapi/group/study/c3609e3e-f80f-482b-9e9f-3a26226a6859/relationships/field_city_region"
				},
				related: {
					href: "https://csis.myclimateservice.eu/jsonapi/group/study/c3609e3e-f80f-482b-9e9f-3a26226a6859/field_city_region"
				}
			}
		},
		field_country: {
			data: {
				...
				id: "aeb9cc1d-9d3a-431c-8b4b-81e031749c87"
			},
			links: {
				self: {
					href: "https://csis.myclimateservice.eu/jsonapi/group/study/c3609e3e-f80f-482b-9e9f-3a26226a6859/relationships/field_country"
				},
				related: {
					href: "https://csis.myclimateservice.eu/jsonapi/group/study/c3609e3e-f80f-482b-9e9f-3a26226a6859/field_country"
				}
			}
		},
		field_data_package: {
			data: {
				type: "node--data_package",
				id: "a8ff7930-4a9f-4289-8246-3383ba13c30f"
			},
			links: {
				self: {
					href: "https://csis.myclimateservice.eu/jsonapi/group/study/c3609e3e-f80f-482b-9e9f-3a26226a6859/relationships/field_data_package"
				},
				related: {
					href: "https://csis.myclimateservice.eu/jsonapi/group/study/c3609e3e-f80f-482b-9e9f-3a26226a6859/field_data_package"
				}
			}
		},
		field_included_contents: {
			data: [
			],
			links: {
				self: {
					href: "https://csis.myclimateservice.eu/jsonapi/group/study/c3609e3e-f80f-482b-9e9f-3a26226a6859/relationships/field_included_contents"
				},
				related: {
					href: "https://csis.myclimateservice.eu/jsonapi/group/study/c3609e3e-f80f-482b-9e9f-3a26226a6859/field_included_contents"
				}
			}
		},
		field_intro: {
			data: {
				type: "taxonomy_term--eu_gl",
				id: "755e32ab-2691-4a75-9dfd-9df494334205"
			},
			links: {
				self: {
					href: "https://csis.myclimateservice.eu/jsonapi/group/study/c3609e3e-f80f-482b-9e9f-3a26226a6859/relationships/field_intro"
				},
				related: {
					href: "https://csis.myclimateservice.eu/jsonapi/group/study/c3609e3e-f80f-482b-9e9f-3a26226a6859/field_intro"
				}
			}
		},
		field_mock_up: {
			data: [
				{
					type: "file--file",
					id: "124c0096-ab54-4052-aeca-b72b279df2e5",
					meta: {
						alt: "",
						title: "",
						width: 1682,
				...
				{
					type: "file--file",
					id: "3beb1d50-183a-4f8e-aba4-e69ebf181d4a",
					meta: {
						alt: "",
						title: "",
						width: 1212,
				...
				{
					type: "file--file",
					id: "f3659c6b-dcdb-4201-8ece-6ca6b148666b",
					meta: {
						alt: "",
						title: "",
						width: 1262,
				...
				{
					type: "file--file",
					id: "284b2752-9fc6-487d-ba7a-646e5b0b16f1",
					meta: {
						alt: "",
						title: "",
						width: 1267,
				...
				{
					type: "file--file",
					id: "360b083e-1560-4688-b223-f9d29076aa8f",
					meta: {
						alt: "",
						title: "",
						width: 1260,
				...
				{
					type: "file--file",
					id: "0c21aa1f-d77b-4222-8706-c399038a3e57",
					meta: {
						alt: "",
						title: "",
						width: 1258,
				...
				{
					type: "file--file",
					id: "9784f9ef-2b24-4ecb-9a91-39a926a5c18f",
					meta: {
						alt: "",
						title: "",
						width: 1251,
			...
			links: {
				self: {
					href: "https://csis.myclimateservice.eu/jsonapi/group/study/c3609e3e-f80f-482b-9e9f-3a26226a6859/relationships/field_mock_up"
				},
				related: {
					href: "https://csis.myclimateservice.eu/jsonapi/group/study/c3609e3e-f80f-482b-9e9f-3a26226a6859/field_mock_up"
				}
			}
		},
		field_sector: {
			data: [
				{
					...
					id: "46843e9c-782e-4be6-b61f-7673c86af13f"
				}
			],
			links: {
				self: {
					href: "https://csis.myclimateservice.eu/jsonapi/group/study/c3609e3e-f80f-482b-9e9f-3a26226a6859/relationships/field_sector"
				},
				related: {
					href: "https://csis.myclimateservice.eu/jsonapi/group/study/c3609e3e-f80f-482b-9e9f-3a26226a6859/field_sector"
				}
			}
		},
		field_study_area_map: {
			data: {
				type: "node--react_mount_with_js",
				id: "54232e62-1046-42c9-8f0d-39f68af36a20"
			},
			links: {
				self: {
					href: "https://csis.myclimateservice.eu/jsonapi/group/study/c3609e3e-f80f-482b-9e9f-3a26226a6859/relationships/field_study_area_map"
				},
				related: {
					href: "https://csis.myclimateservice.eu/jsonapi/group/study/c3609e3e-f80f-482b-9e9f-3a26226a6859/field_study_area_map"
				}
			}
		},
		field_study_type: {
			data: {
				type: "taxonomy_term--study_type",
				id: "2a03ba0a-9356-4a38-96d6-0fed4835551c"
			},
			links: {
				self: {
					href: "https://csis.myclimateservice.eu/jsonapi/group/study/c3609e3e-f80f-482b-9e9f-3a26226a6859/relationships/field_study_type"
				},
				related: {
					href: "https://csis.myclimateservice.eu/jsonapi/group/study/c3609e3e-f80f-482b-9e9f-3a26226a6859/field_study_type"
				}
			}
		},
		field_under_construction: {
			...
			links: {
				self: {
					href: "https://csis.myclimateservice.eu/jsonapi/group/study/c3609e3e-f80f-482b-9e9f-3a26226a6859/relationships/field_under_construction"
				},
				related: {
					href: "https://csis.myclimateservice.eu/jsonapi/group/study/c3609e3e-f80f-482b-9e9f-3a26226a6859/field_under_construction"
				}
			}
		}
	},
	links: {
		self: {
			href: "https://csis.myclimateservice.eu/jsonapi/group/study/c3609e3e-f80f-482b-9e9f-3a26226a6859"
		}
	}
};
var links = {
...
var apiResponseStudy = {
	jsonapi: jsonapi,
	data: data,
	links: links
};

var CSISRemoteHelpersTests = function CSISRemoteHelpersTests() {
  log$1.enableAll();
  /**
  ...
  function () {
    var _ref = asyncToGenerator(
    /*#__PURE__*/
    regenerator.mark(function _callee(done) {
      return regenerator.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              if (process.env.COOKIE && process.env.ORIGIN) {
                log$1.info('headers.js fixture found, executing remote API tests'); // this will fail when a new instance of axios has been created in CSISRemoteHelpers
                ...
                csisClient.defaults.headers.common['Cookie'] = process.env.COOKIE;
                csisClient.defaults.headers.common['Origin'] = process.env.Origin;
                dist_2.csisClient.defaults.headers.common['Cookie'] = process.env.COOKIE;
                dist_2.csisClient.defaults.headers.common['Origin'] = process.env.Origin;
              } else {
                log$1.warn('no headers ENV VAR (.env.test.local) found, skipping remote API tests');
              }
  ...
  function () {
    var _ref2 = asyncToGenerator(
    /*#__PURE__*/
    regenerator.mark(function _callee2(done) {
      var xCsrfToken;
      return regenerator.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return getXCsrfToken();

            case 2:
              xCsrfToken = _context2.sent;
              csisClient.defaults.headers.common[axios$1.defaults.xsrfHeaderName] = xCsrfToken;
              done();
  ...
  afterAll(function () {
    ...
    delete csisClient.defaults.headers.common[axios$1.defaults.xsrfHeaderName];

    if (process.env.COOKIE && process.env.ORIGIN) {
      delete csisClient.defaults.headers.common['Cookie'];
      delete csisClient.defaults.headers.common['Origin'];
      delete dist_2.csisClient.defaults.headers.common['Cookie'];
      delete dist_2.csisClient.defaults.headers.common['Origin'];
    }
  });
  describe('Remote API tests without authentication', function () {
    test('get and compare X-CSRF Token',
    /*#__PURE__*/
    function () {
      var _ref3 = asyncToGenerator(
      /*#__PURE__*/
      regenerator.mark(function _callee3(done) {
        var token1, token2;
        return regenerator.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 3:
                token1 = _context3.sent;
                _context3.next = 6;
                return getXCsrfToken();

              case 6:
                token2 = _context3.sent;
  ...
  describe('Remote API tests with authentication', function () {
    if (!process.env.COOKIE || !process.env.ORIGIN) {
      it.only('no headers.js fixture found, skipping remote API tests', function () {
        log$1.warn('no headers.js fixture found, skipping remote API tests');
      });
    }

    it('[DEV] test get EMIKAT Credentials',
    /*#__PURE__*/
    function () {
      var _ref4 = asyncToGenerator(
      /*#__PURE__*/
      regenerator.mark(function _callee4(done) {
        var emikatCredentials;
        return regenerator.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.next = 2;
                return getEmikatCredentialsFromCsis();

              case 2:
                emikatCredentials = _context4.sent;
                expect.assertions(2);
    ...
    it('[PROD] test get EMIKAT Credentials',
    /*#__PURE__*/
    function () {
      var _ref5 = asyncToGenerator(
      /*#__PURE__*/
      regenerator.mark(function _callee5(done) {
        var emikatCredentials;
        return regenerator.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                _context5.next = 2;
                return dist_2.getEmikatCredentialsFromCsis();

              case 2:
                emikatCredentials = _context5.sent;
                expect.assertions(2);
                expect(emikatCredentials).toBeDefined();
                expect(emikatCredentials).not.toBeNull();
                done();
    ...
    it('[DEV] test get complete Study',
    /*#__PURE__*/
    function () {
      var _ref6 = asyncToGenerator(
      /*#__PURE__*/
      regenerator.mark(function _callee6(done) {
        var studyGroupNode;
        return regenerator.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                _context6.next = 2;
                return getStudyGroupNodeFromCsis(undefined, 'c3609e3e-f80f-482b-9e9f-3a26226a6859');

              case 2:
                studyGroupNode = _context6.sent;
                expect.assertions(6);
    ...
    it('[PROD] test get complete Study',
    /*#__PURE__*/
    function () {
      var _ref7 = asyncToGenerator(
      /*#__PURE__*/
      regenerator.mark(function _callee7(done) {
        var studyGroupNode;
        return regenerator.wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                _context7.next = 2;
                return dist_2.getStudyGroupNodeFromCsis(undefined, 'c3609e3e-f80f-482b-9e9f-3a26226a6859');

              case 2:
                studyGroupNode = _context7.sent;
                expect.assertions(6);
                expect(studyGroupNode).toBeDefined();
                expect(studyGroupNode).not.toBeNull();
                expect(apiResponseStudy).toBeDefined();
    ...
    it('[DEV] test get datapackage resources for eu-gl:hazard-characterization',
    /*#__PURE__*/
    function () {
      var _ref8 = asyncToGenerator(
      /*#__PURE__*/
      regenerator.mark(function _callee8(done) {
        var resourcesApiResponse, filteredResources;
        return regenerator.wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                _context8.next = 2;
                return getDatapackageResourcesFromCsis(undefined, "a8ff7930-4a9f-4289-8246-3383ba13c30f");

              case 2:
                resourcesApiResponse = _context8.sent;
                expect.assertions(6);
                ...
                filteredResources = filterResourcesByEuglId(resourcesApiResponse.data, resourcesApiResponse.included, 'eu-gl:hazard-characterization');
                log$1.info("filteredResources: ".concat(filteredResources.length));
...
CSISRemoteHelpersTests();
var CSISRemoteHelpers_test = CSISRemoteHelpersTests();

log$1.enableAll();

exports.CSISHelpers = CSISHelpers$1;
exports.CSISRemoteHelpers = CSISRemoteHelpers;
exports.CSISRemoteHelpersTests = CSISRemoteHelpers_test;
exports.EMIKATHelpers = EMIKATHelpers;

});

unwrapExports(dist_4);
var dist_5 = dist_4.CSISHelpers;
var dist_6 = dist_4.CSISRemoteHelpers;
var dist_7 = dist_4.CSISRemoteHelpersTests;
var dist_8 = dist_4.EMIKATHelpers;
...
var CSISRemoteHelpersTests = function CSISRemoteHelpersTests() {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              //axios.defaults.withCredentials = true;
              if (process.env.COOKIE && process.env.ORIGIN) {
                log.info('headers.js fixture found, executing remote API tests'); // this will fail when a new instance of axios has been created in CSISRemoteHelpers
                // because the instance is created with the *previous* defaults! :o
                //axios.defaults.headers.common[header[0]] = header[1];
                // therefore we change the instance in CSISRemoteHelpers :o
                ...
                csisClient.defaults.headers.common['Cookie'] = process.env.COOKIE;
                csisClient.defaults.headers.common['Origin'] = process.env.Origin;
                dist_6.csisClient.defaults.headers.common['Cookie'] = process.env.COOKIE;
                dist_6.csisClient.defaults.headers.common['Origin'] = process.env.Origin;
              } else {
      ...
      return regenerator.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 2:
              xCsrfToken = _context2.sent;
              csisClient.defaults.headers.common[axios.defaults.xsrfHeaderName] = xCsrfToken;
              done();
  ...
  afterAll(function () {
    //delete axios.defaults.withCredentials;
    delete csisClient.defaults.headers.common[axios.defaults.xsrfHeaderName];

    if (process.env.COOKIE && process.env.ORIGIN) {
      delete csisClient.defaults.headers.common['Cookie'];
      delete csisClient.defaults.headers.common['Origin'];
      delete dist_6.csisClient.defaults.headers.common['Cookie'];
      delete dist_6.csisClient.defaults.headers.common['Origin'];
    }
  });
  describe('Remote API tests without authentication', function () {
    test('get and compare X-CSRF Token',
        ...
        return regenerator.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                _context5.next = 2;
                return dist_6.getEmikatCredentialsFromCsis();
        ...
        return regenerator.wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                _context7.next = 2;
                return dist_6.getStudyGroupNodeFromCsis(undefined, 'c3609e3e-f80f-482b-9e9f-3a26226a6859');
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              ...
              case 2:
                ...
                expect(resourcesApiResponse.included).not.toBeNull();
                filteredResources = filterResourcesByEuglId(resourcesApiResponse.data, resourcesApiResponse.included, 'eu-gl:hazard-characterization');
                log.info("filteredResources: ".concat(filteredResources.length));
                expect(filteredResources).not.toBeNull();
                expect(filteredResources.length).toBeGreaterThan(0);
                done();
...
export { CSISHelpers$1 as CSISHelpers, CSISRemoteHelpers, CSISRemoteHelpersTests, EMIKATHelpers };
